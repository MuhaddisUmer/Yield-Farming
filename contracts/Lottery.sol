...
/// @notice This contract adds a lottery feature to the MyFarm contract that uses
///         the NFT tokenId as the "ticket." This contract uses Chainlink's VRF to 
///         achieve verifiable randomness for the winning number
/// @dev Basic iteration of a lottery feature in the MyFarm dApp. MyFarm's mintNFT
...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    /// @dev The MyFarm contract primarily calls this function within its mintNFT function
